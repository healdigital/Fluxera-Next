...
export default function UserActivityErrorPage({
  error,
  reset,
}: {
  ...
  return (
    <>
      <PageHeader
        title={
          <Trans i18nKey="users:activityLog" defaults="User Activity Log" />
        }
      ...
      <PageBody>
        <div className="flex flex-col space-y-4">
          <Alert variant="destructive">
            ...
            <AlertTitle>
              <Trans
                i18nKey="users:errorLoadingActivity"
            ...
            <AlertDescription className="space-y-2">
              <p>
                <Trans
                  i18nKey="users:errorLoadingActivityDescription"
              ...
              {errorMessage.action && (
                <p className="text-sm font-medium">
                  <Trans
                    i18nKey="users:errorLoadingActivityAction"
