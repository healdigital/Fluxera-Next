...
interface CreateLicenseSheetProps {
  open: boolean;
...
/**
 * CreateLicenseSheet - Slide-in sheet for creating new licenses
 *
 * Features:
 * - Form validation with real-time feedback
 * - Duplicate license key prevention
...
export function CreateLicenseSheet({
  ...
  return (
    <FormSheet
      ...
      description="Add a new software license to your inventory"
      side="right"
      size="lg"
