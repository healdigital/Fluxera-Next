...
export default function NewLicenseErrorPage({
  error,
  reset,
}: {
  ...
  const errorMessage = LicenseErrors.CREATE_FAILED;
      ...
      <PageBody>
        <div className="flex flex-col space-y-4">
          <Alert variant="destructive">
            ...
            <AlertTitle>
              <Trans
                i18nKey="licenses:errorCreatingLicense"
            ...
            <AlertDescription className="space-y-2">
              <p>
                <Trans
                  i18nKey="licenses:errorCreatingLicenseDescription"
              ...
              {errorMessage.action && (
                <p className="text-sm font-medium">
                  <Trans
                    i18nKey="licenses:errorCreatingLicenseAction"
