-- Add get_team_members_count function for efficient pagination
-- This function returns the total count of team members matching the filter criteria
-- without fetching all the data, which is more efficient for pagination
...
comment on function public.get_team_members_count is 'Get the total count of team members matching filter criteria for pagination';
