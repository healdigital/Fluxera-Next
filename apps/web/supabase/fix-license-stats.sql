-- Temporary fix: Add the missing get_license_stats function
...
-- Create the get_license_stats function
...
select 'Function get_license_stats created successfully' as status;
